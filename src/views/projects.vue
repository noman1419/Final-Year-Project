            ...
            <div class="white-contianer bg-white">
                ...
                <div class="card-container advance-body">
                    <div class="card-display" style="width:100%"
                        ...
                        <div class="card" @click="addCardStatus(itm)" v-if="userInfo.type != 'Employee'">
...
export default {
    ...
    methods: {
        ...
        async init(){
            ...
            try{
                const userRef = this.$data.query(this.$data.collection(this.$data.db, "project"),this.$data.where("project_name", "==", this.route_id))
